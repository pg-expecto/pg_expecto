...
- **Версия 10** – реализация цепи Маркова для прогнозирования инцидентов производительности СУБД PostgreSQL - описание https://github.com/pg-expecto/pg_expecto/tree/main/Markov_chain_docs
