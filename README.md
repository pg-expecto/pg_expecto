...
[PG_EXPECTO: стратегия развития и исследовательские векторы](https://dzen.ru/a/aW3F-Lz9xAmT0ytZ?share_to=link)
...
- **Версия 6.0** : Имитация нагрузки OLTP/OLAP, сбор статистики vm_dirty* , сбор статистики shared_buffers, дополненные отчеты IO, RAM.
...
- [PG_EXPECTO 5.2 : Иммитация OLAP нагрузки](https://dzen.ru/a/aW-JVhKDJmav3Gcm?share_to=link)
