...
- **Интеграция с нейросетью:** Автоматическая подготовка промптов к нейросети для анализа статистически обработанных метрик производительности СУБД и инфраструктуры.
